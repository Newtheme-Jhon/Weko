            ...
            <div class="col-sm-12">
                <div class="card border-light mb-3" style="max-width:100%;">
                    <div class="card-header">
                        <h5>Contenidos Servicios</h5> // todo esto esta en el archvio servicios.php
                    </div>
                    <div class="card-body">
                        <?php for($i = 0; $i<count($data_servicios); $i++):?>
                            ...
                            <?php 
                                ...
                                // Quitando barras inverdidas que se producen al enviar html
                            ...
                            <!--Todo esto es un formulario donde se van almacenar los datos
                            que se van a ver en el bloque de servicios que pondremos en el frontend -->