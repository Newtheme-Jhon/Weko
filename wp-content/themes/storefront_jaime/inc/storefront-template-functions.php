...
if ( ! function_exists( 'storefront_footer_widgets' ) ) {
	...
	function storefront_footer_widgets() {
		$rows    = intval( apply_filters( 'storefront_footer_widget_rows', 1 ) );// desde aqui podemos añadir filas
		$regions = intval( apply_filters( 'storefront_footer_widget_columns', 4 ) ); // podemos añadir columnas
...
if ( ! function_exists( 'storefront_primary_navigation_wrapper' ) ) {
	...
	function storefront_primary_navigation_wrapper() {
		echo '<div class="storefront-primary-navigation"><div class="col-full col-inferior">';
	}
}
...
if ( ! function_exists( 'storefront_header_container' ) ) {
	...
	function storefront_header_container() {
		echo '<div class="col-full col superior">';
	}
}
